...
export const SeconderyGreyButton = styled.div`
  ...
  box-shadow: ${(props) =>
    props.isplaying === 1 ? "1px 2px 3px 0px black" : "3px 4px 6px 0px black"};
...
export const MainBlueLight = styled.div`
  ...
  background: linear-gradient(
    135deg,
    rgba(161, 218, 254, 1) 0%,
    rgba(40, 170, 253, 1) 30%,
    rgba(25, 106, 158, 1) 100%
  );
  width: 35px;
  height: 35px;
  border-radius: 25px;
  ...
  border: 1px solid black;
  margin-right: 10px;
  box-shadow: 0 0 0 5px #dedede, 0 0 0 6px #000000;
`;
